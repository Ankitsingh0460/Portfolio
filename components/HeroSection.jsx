...
const HeaderSeaction = () => {
  ...
  const handleResumeDownload = () => {
    ...
    link.download = "Ankit_Singh Resume.pdf";
    link.click();
  };
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white text-4xl sm:text-5xl lg:text-6xl mb-4 font-extrabold">
            <div className=" mb-4 text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text">
              Hello, I am
            </div>
            <TypeAnimation
              sequence={[
          ...
          <p className=" text-base sm:text-lg lg:text-xl  text-gray-400 mb-4">
            I am ready to contribute to innovative projects and make a
            meaningful impact.
          </p>
          <div className=" flex flex-col sm:flex-row gap-3 mt-3">
            <button
              onClick={scrollToContact}
              className="p-3 w-full sm:w-fit text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full mr-4 hover:bg-opacity-90 font-bold border border-white"
            >
              Hire Me
            </button>
            <button
              className="p-3 w-full font-bold sm:w-fit text-white bg-transparent rounded-full border border-white 
